...
ssh -o StrictHostKeyChecking=no -i /var/lib/jenkins/.ssh/id_rsa_amazonlinux ec2-user@18.191.100.182 "docker login --password=admin123 --username=admin 40141c99.ngrok.io"
